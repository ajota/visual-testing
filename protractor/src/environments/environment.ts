...
export const headers = {
  ...
  'Ocp-Apim-Subscription-Key': '9bb064f0a3f1475b97150bbeea32599b',
  SCLocation: '0,0',
  country: 'co',
...
export const firebase = {
  ...
  databaseURL: 'https://credinet2019-development.firebaseio.com/',
...
export const credentialsPaymentGateway = {
  idPagoAgil: '{8c3c55ea-f51e-49ca-a09c-99a56c896417}',
  urlPagoAgil: 'https://www.pagoagil.net/onestep',
  ResponsePagoAgil: 'pagoagil/dev/respuestapagoagil',
  mode: '1'
};
/*
